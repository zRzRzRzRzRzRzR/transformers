...
class Glm4vTextConfig(PretrainedConfig):
    ...
    >>> # Initializing a Glm4v style configuration
    >>> configuration = Glm4vConfig()

    >>> # Initializing a model from the GLM-4V style configuration
...
class Glm4vConfig(PretrainedConfig):
    ...
    >>> # Initializing a GLM-4V style configuration
    >>> configuration = Glm4vConfig()

    >>> # Initializing a model from the CLM4V style configuration
